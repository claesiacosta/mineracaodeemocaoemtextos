...
phraseswithstemmingtraining = applystemmer(basetreinamento)
phraseswithstemmingtest = applystemmer(baseteste)
...
wordstraining = searchwords(phraseswithstemmingtraining)
wordstest = searchwords(phraseswithstemmingtest)
#print(words)
...
frequencytraining = searchfrequency(wordstraining)
frequencytest = searchfrequency(wordstest)
...
uniquewordstraining = searchuniquewords(frequencytraining)
uniquewordstest = searchuniquewords(frequencytest)
#print(uniquewords)
...
def wordsextractor(document):
	doc = set(document)
	features = {}
	for words in uniquewordstraining:
...
completdatatraining = nltk.classify.apply_features(wordsextractor, phraseswithstemmingtraining)
completdatatest = nltk.classify.apply_features(wordsextractor, phraseswithstemmingtest)
#print(completdata)


#Classificação - constroi a tabela de probabilidade
classificador = nltk.NaiveBayesClassifier.train(completdatatraining)

#identifica os atribuitos/classes/ rotulos
...
#print(nltk.classify.accuracy(classificador, completdatatest))

erros = []
for(frase, classe) in completdatatest:
	#print(frase)
	#print(classe)
